        ...
        <div className="partners__elems">
          <div className="partners__elem">
            <div className="partners__elem-text">
              При возникновении вопросов, сотрудники УК открыто, быстро и четко
              находят на них ответы. Всегда готовы дать советы, исходя из
              накопленного за 10 лет опыта работы компании.
            </div>
            <div className="partners__elem-bottom">
              <div className="partners__elem-left">
                <div className="partners__elem-author">Артем</div>
                <div className="partners__elem-city">партнер в Йошкар-Оле</div>
              </div>
          ...
          <div className="partners__elem">
            <div className="partners__elem-text">
              Мы первые партнеры по франшизе Блинбери. Довольны сопровождением:
              ребята помогают в открытии и советуют, что улучшить в операционной
              работе.
            </div>
            <div className="partners__elem-bottom">
              <div className="partners__elem-left">
          ...
          <div className="partners__elem">
            <div className="partners__elem-text">
              Наставники обучают быстро, понятно, с вниманием. Аттестацию сдала
              с первого раза. Блинбери Академия - отличная возможность обучать
              сотрудников, не отправляя их в длительные командировки.
            </div>
            <div className="partners__elem-bottom">
              <div className="partners__elem-left">
