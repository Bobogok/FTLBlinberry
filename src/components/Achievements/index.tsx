      ...
      <div className="achievements__inner container">
        ...
        <div className="achievements__elems">
          ...
          >
            ...
            <SwiperSlide className="achievements__elem">
              <div className="achievements__elem-content">
                В августе 2019 года открылась первая блинная по франшизе в Пензе
              </div>
            ...
            <SwiperSlide className="achievements__elem">
              <div className="achievements__elem-content">
                В октябре 2020 года мы определили “North star” стать блинной №1
                в мире и открыть 5 000 блинных к 2030 г.
              </div>
            ...
            <SwiperSlide className="achievements__elem">
              <div className="achievements__elem-content">
                В августе 2021 открыли первую блинную на побережье Черного моря
                в солнечном Сочи
              </div>
            ...
            <SwiperSlide className="achievements__elem">
              <div className="achievements__elem-content">
                В июне 2022 года открыли 3 топовых блинных в центре Москвы за 3
                недели
              </div>
